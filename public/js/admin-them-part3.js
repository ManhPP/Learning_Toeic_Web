...
var inputQues = function(callback) {
    ...
    $(document).on("click", ".ico-edit", function() {
        ...
        $("input[name='choise'][value='A']").click();
...
$(document).on("click","#add-part", function(){
    ...
    $(".block").each(function(i){
        ...
        $(this).find("div.ques").each(function(){
            ...
            if(cauHoi.length == 0 || typeof (daDung) =="undefined"){
                isEnough=false;
            }
            ...
            if(listCau.length==1){
                listCau+='{"id":"null","cauHoi":"'+cauHoi+'","dAA":"'+arrDa[0]+'","dAB":"'
        ...
        if(listHoiThoai.length==1){
            listHoiThoai+='{"id":"null","loaiPart":"Part 3"}';
        }else{
            listHoiThoai+=',{"id":"null","loaiPart":"Part 3"}';
        }
    });
    ...
    console.log(arrListCau);
    listHoiThoai+="]";
    
    partNghe='{"id":"null","intro":"'+intro+'", "audio":"'+audio+'","loaiPart":"Part 3" ,"acessCount":0,"title":"'+tittle
                +'" }';
