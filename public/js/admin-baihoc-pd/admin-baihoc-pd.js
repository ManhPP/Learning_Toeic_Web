                                ...
                                success : function (data) {
                                    ...
                                    for (var i = 0; i < data.length; i++) {
                                        ...
                                        tbody+= '<td class="col-sm-3 col-md-3">'+data[i].accessCount+'</td>'
                                                ...
                                                +'/guest/luyen-doc?id='+data[i].id
                                                +'">View</a>/<a target="_blank" class="update" href="'
                                                +$("#root-path").html()
                                                +'/admin/bai-hoc-manager/update-part-doc?id='+data[i].id
                                                +'">Update</a></div></td></tr>';
                                    }
...
//                        $("#model-input-filter .modal-body input").remove();
                        ...
                        if ($(this).parent().find("span").html() == "ID"
                            ...
                            $("#model-input-filter .modal-body").append(
                                    ...
                                    +"<label class='col-12'><input checked='checked' type='radio' name='choose-type' value='5'/>Part 5</label>"
                                    +"<label class='col-12'><input type='radio' name='choose-type' value='6'/>Part 6</label>"
                                    +"<label class='col-12'><input type='radio' name='choose-type' value='7'/>Part 7</label></div>"
                                    +"<input class='hide' id='filter-val' value='5' type='text'/`>")
                        }
