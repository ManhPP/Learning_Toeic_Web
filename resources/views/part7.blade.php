...
@section("css")
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset("css/part5.css") }}">
@endsection
@section('navbar')
    @parent
@endsection
                ...
                <div class="p1 col-10">
                    ...
                    <div class="list-cau">
                        ...
                        @for ($i=1;$i<=10;$i++)
                            ...
                            echo "<span class='col-12'> <input type=\"radio\" name=\"choise$i\">A: sdasdaasdsa</span>
                                <span class='col-12'> <input type=\"radio\" name=\"choise$i\">B: sdasdaasdsa</span>
                                <span class='col-12'> <input type=\"radio\" name=\"choise$i\">C: sdasdaasdsa</span>
                                <span class='col-12'> <input type=\"radio\" name=\"choise$i\">D: sdasdaasdsa</span>
                            </div></div>";
                            ?>
                        @endfor
