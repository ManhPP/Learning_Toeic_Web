...
@section('title','bai kiem tra')
@section("css")
    <link rel="stylesheet" type="text/css" href="{{ URL::asset("css/user_bkt_home/user_bkt_home.css") }}">
...
@section('content')
	...
	<div class="body">
                            ...
                            @foreach($arrBKT as $bkt)
                                <div class="swiper-slide row suggest" data-id="{{ $bkt->id }}" data-path="{{Route("testcontroller.dotest")}}?id={{ $bkt->id }}">
                                    ...
                                    <div class="detail-lession col-12">
                                        <span>Bài kiểm tra: </span><span>{{ $bkt->title }}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            <!-- table -->
            <div class="container-fluid margin-bottom19">
...
@section('js')
    <script type="text/javascript" src="{{ URL::asset("js/user_bkt_home/user_bkt_home.js") }}"></script>
