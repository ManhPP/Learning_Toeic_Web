...
@section('title','practice part 3')
@section("css")
    <link rel="stylesheet" type="text/css" href="{{ URL::asset("css/guest_part3_view/guest_part3_view.css") }}">
@endsection
@section('navbar')
    @parent
@endsection
...
@section('js')
    <script type="text/javascript" src="{{ URL::asset("js/guest_part3_view/guest_part3_view.js") }}"></script>
@endsection	