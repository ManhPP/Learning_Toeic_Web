...
@section('title','them bai thao luan')
@section("css")
    <link rel="stylesheet" type="text/css" href="{{ URL::asset("css/them_bai_thaoluan/them_bai_thaoluan.css") }}">
@endsection
@section('navbar')
    @parent
@endsection
