...
@section('title',"practice listening home")
@section("css")
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide row">
						<div class="cover-lession col-12">
							<img src="{{URL::asset("imgs/prHome/listening.png")}}">
						</div>
		...
		<dir class="content-body">
			<div class="header-suggess row">
				...
				<div class="search-div col-9">
					<input id="search-input" type="text" name="search" placeholder="Search listening">
