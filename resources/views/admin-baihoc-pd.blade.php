						...
						<tbody>
							...
							@foreach( $arrBaiHoc as $baiHoc )
								<tr class="d-flex">
									...
									<a target="_blank" class="view" href="{{URL("")}}/guest/luyen-doc/{{$baiHoc->id}}">View</a>/<a target="_blank" class="update" href="{{URL("")}}/admin/bai-hoc-manager/update-part-doc/{{$baiHoc->id}}"}>Update</a>
									</div></td>
								</tr>
								<?php $index +=1 ?>
							@endforeach
