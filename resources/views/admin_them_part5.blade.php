...
@section('content')
	...
	<div class="body row">
		<div class="row col-12 col-sm-11 col-md-10 col-lg-9 col-xl-8 align-center no-padding">
			<div class="label-style">**Tạo đề thi từ ngân hàng câu hỏi (<a target="_blank" style="font-size: 0.9em" href="{{Route("part5controller.index")}}">Cập nhập ngân hàng câu hỏi!</a>)</div>
	...
	<div class="modal fade" tabindex="-1" role="dialog"
		...
		<button type="button" class="btn btn-default" id="btn-input-yes" style="background-color:coral" data-next="false">Ok</button>
